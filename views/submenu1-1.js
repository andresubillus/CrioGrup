function iniciarsubmenu11() {
  const tablaEnvases = document.getElementById('tablaEnvases');
  const formEnvase = document.getElementById('formEnvase');

  const datosIniciales = [
    { codigo: '254664', propietario: 'Andres S.A.C', fecha: '2025-07-26', estado: 'PH' },
    { codigo: '336514', propietario: 'Andres S.A.C', fecha: '2030-04-11', estado: 'Despacho' },
    { codigo: '555874', propietario: 'Andres S.A.C', fecha: '2030-04-18', estado: 'Observación' },
    { codigo: '585858', propietario: 'Andres S.A.C', fecha: '2025-07-09', estado: 'Falta PH' }
  ];
